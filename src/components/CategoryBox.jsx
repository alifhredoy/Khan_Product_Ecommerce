...
const CategoryBox = ({ text, icon, className }) => {
    return (
        <div className={`cursor-pointer group hover:bg-[#DB4444] hover:border-transparent duration-500 w-[170px] h-[145px] rounded-sm flex flex-col items-center justify-center border border-[#0000004d] ${className}`}>

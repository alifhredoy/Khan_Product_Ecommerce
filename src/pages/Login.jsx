              ...
              <div className='flex justify-center items-center z-50 absolute top-0 left-0 w-full h-screen bg-[#00000099]'>
                ...
                <div className='w-[600px] py-[150px] px-10 bg-white rounded-md'>
                  ...
                  <div className='mt-5'>
                    ...
                    <Button onClick={handleReturn} className="!bg-red-500 hover:!text-white" text="Return" />


                    <Button onClick={handleSendEmail} className="!bg-blue-500 hover:!text-white ml-5" text="Send" />

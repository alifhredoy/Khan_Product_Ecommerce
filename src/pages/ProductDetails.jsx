                ...
                singleproduct.map(item => (
                  <>
                    <Flex className='py-20'>
                      ...
                      <h2 className='text-sm text-gray-400 font-pop font-normal'>Products <span className='px-2'> /</span></h2>
                      <p className='text-sm text-black font-pop font-normal'>{item.title}</p>

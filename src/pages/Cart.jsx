...
const Cart = () => {
  ...
  const data = useSelector((state) => state.breadcrumb.previousvalue)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="items-start">
              <input
                ...
                className="py-4 pl-6 pr-20 outline-0 border border-black rounded-sm mr-4"
              />

              <Button
                text="Apply Coupon"
                className="hover:bg-red-600! text-white! border-transparent"
              />
            ...
            <div className="justify-self-end">
              ...
              <div className="w-[470px] border border-black rounded-sm py-8 px-4">
                ...
                <h6 className="text-xl text-black font-pop font-medium pb-6">
                  Cart Total
                </h6>
